...
/**
 * 🛠️ STRUMENTO DI MOCK TESTING PER AMBIENTE BACKEND ISOLATO (VERSIONE CORRETTA)
...
add_action( 'init', function() {
    ...
    if ( class_exists( 'WpEsg\Storage\UserCompanyLinker' ) ) {
        // Passiamo 4 parametri incorporando l'anno contabile come richiesto dalla firma del metodo
